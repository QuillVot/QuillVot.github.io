 ...
 */
const defaultLanguage = ["en","en-US"];
...
function handleBrowserLanguageRedirect() {
    ...
    } else if (!supportedLanguage && !(browserLanguage in supportedLanguages) && currentLanguagePath !== notMatchedLanguage) {
